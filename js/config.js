...
const INIZIO = {
  ...
  galeria: [
    ...
    { tipo: 'video', src: 'video/rodny-acrobacias-2.mp4',                        poster: 'img/campeonato/rodny-campeonato-foto-oficial.jpg', alt: 'Rodny — freestyle pizza en campeonato', cat: 'Freestyle' },
    ...
    { tipo: 'foto',  src: 'img/campeonato/rodny-campeonato-foto-oficial.jpg',     alt: 'Rodny López en Revista Pizza DOC',                                        cat: 'Prensa'      },
    ...
    { tipo: 'video', src: 'video/rodny-acrobacias-3.mp4',         poster: 'img/campeonato/rodny-campeonato-foto-oficial.jpg', alt: 'Rodny — malabarismo con la masa',                     cat: 'Freestyle' },
    { tipo: 'video', src: 'video/rodny-acrobacias-4.mp4',         poster: 'img/campeonato/rodny-campeonato-foto-oficial.jpg', alt: 'Rodny — acrobacias pizza en competición',             cat: 'Freestyle' },
    { tipo: 'video', src: 'video/rodny-acrobacias-5.mp4',         poster: 'img/campeonato/rodny-campeonato-foto-oficial.jpg', alt: 'Rodny — freestyle y piruetas con pizza',              cat: 'Freestyle' },
    { tipo: 'video', src: 'video/rodny-acrobacias-6.mp4',         poster: 'img/campeonato/rodny-campeonato-foto-oficial.jpg', alt: 'Rodny — acrobacias napolitanas',                      cat: 'Freestyle' },
    { tipo: 'video', src: 'video/rodny-acrobacias-7.mp4',         poster: 'img/campeonato/rodny-campeonato-foto-oficial.jpg', alt: 'Rodny — show de pizza acrobática',                    cat: 'Freestyle' },
    { tipo: 'video', src: 'video/rodny-tecnica-masa.mp4',         poster: 'img/campeonato/rodny-campeonato-foto-oficial.jpg', alt: 'Técnica de masa napolitana — Rodny López',            cat: 'Técnica'   },
  ],
